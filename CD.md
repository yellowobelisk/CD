...
int main() {
    ...
    if (scanf("%d", &intVar) == 1) {
        printf("Input is an integer. Stored in intVar\n");
    } else {
    ...
    if (scanf("%f", &floatVar) == 1) {
        printf("Input is a float. Stored in floatVar\n");
    } else {
    ...
    if (scanf(" %c", &charVar) == 1) {
        printf("Input is a character. Stored in charVar\n");
    } else {
    ...
    printf("Enter a string: ");
    if (scanf("%s", stringVar) == 1) {
        printf("Input is a string. Stored in stringVar\n");
    } else {
